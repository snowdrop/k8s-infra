...
In case of using `v3password` authentication plugin the following 
...
* *link:../ansible/playbooks/openstack/openstack_auth_passstore_v3password.yml[openstack_auth_passstore_v3password.yml] <= Default*
* link:../ansible/playbooks/openstack/openstack_auth_passstore_v3applicationcredential.yml[openstack_auth_passstore_v3applicationcredential.yml]
...
All the information related to the Ansible Inventory for RHOSP host will be 
 managed by our ansible passwordstore link:../../roles/passstore[roles] and 
 link:../passstore[playbooks].
...
More information on RHOSP networks link:openstack-cli.adoc#network[here] 
 and link:https://docs.openstack.org/python-openstackclient/latest/cli/command-objects/network.html[here].
