...
From there, download the `OpenStack RC file` bash file by clicking on the button and store somwhere (e.g ./rhos-openrc.sh).
...
```
openstack image show 8b8ab2a1-e349-4313-9a38-a800f42ffe99 -f shell
```
