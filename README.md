...
| 2 | Local Machine       | Ansible, oc    | `oc cluster up`      | CentOS                | Virtualbox        |
| 3 | Remote Public  - Hetzner   | Ansible    | `systemctl service`  | CentOS                | -                 |
| 4 | Remote Private - OpenStack | Ansible    | `systemctl service`  | CentOS                | -                 |
