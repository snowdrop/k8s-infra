...
The version of the cluster created can be changed using the parameter `k8s_version`. The following versions are currently supported:

[source,yaml,indent=0]
----
include::vars/main.yml[lines=2..15]
----
