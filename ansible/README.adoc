...
[NOTE]
====
Since passwordstore is integrated with linkhttps://git-scm.com/[git], all changes made locally to a pass repository are automatically committed to the local git repo.
====
